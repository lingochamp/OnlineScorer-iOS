...
typedef void (^data_callback)(EZSRWebSocket *webSocket,  NSData *data);
...
@interface EZSRWebSocket ()  <NSStreamDelegate>
...
@implementation EZSRWebSocket {
    ...
    __strong EZSRWebSocket *_selfRetain;
...
- (void)_readHTTPHeader;
{
    ...
    [self _readUntilHeaderCompleteWithCallback:^(EZSRWebSocket *self,  NSData *data) {
...
- (void)_handleFrameHeader:(frame_header)frame_header curData:(NSData *)curData;
{
    ...
    if (frame_header.payload_length == 0) {
        ...
        [self _addConsumerWithDataLength:(size_t)frame_header.payload_length callback:^(EZSRWebSocket *self, NSData *newData) {
            if (isControlFrame) {
...
- (void)_readFrameContinue;
{
    ...
    [self _addConsumerWithDataLength:2 callback:^(EZSRWebSocket *self, NSData *data) {
        ...
        if (extra_bytes_needed == 0) {
            ...
            [self _addConsumerWithDataLength:extra_bytes_needed callback:^(EZSRWebSocket *self, NSData *data) {
