...
@protocol EZSRWebSocketDelegate;

#pragma mark - SRWebSocket

@interface EZSRWebSocket : NSObject <NSStreamDelegate>

@property (nonatomic, weak) id <EZSRWebSocketDelegate> delegate;
...
@protocol EZSRWebSocketDelegate <NSObject>
...
- (void)webSocket:(EZSRWebSocket *)webSocket didReceivePong:(NSData *)pongPayload;
